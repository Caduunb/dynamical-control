...
if(strcmp(file, 'dadosQ') || strcmp(file, 'dadosQ.mat'))
    entrada = (dados(5, 1:datasize-1))';      % system input from r1 to rn-1 as a column vector
    saida   = (dados(4, 1:datasize-1))';      % actuator output from y1 to yn-1 as a column vector
    Y       = (dados(4, 2:datasize))';        % output Y as a column vector from y2 to yn
